# Generated by Django 3.1.4 on 2020-12-30 12:00

from django.db import migrations, models
import django.db.models.deletion
import django.db.models.manager
import fastsite.salesforce_models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Name', salesforce.fields.CharField(db_column='Name', max_length=255)),
                ('Balance_Due', salesforce.fields.CharField(max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LastModifiedDate', salesforce.fields.DateTimeField(auto_now=True, db_column='LastModifiedDate')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', salesforce.fields.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.account')),
            ],
            options={
                'db_table': 'Contact',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', salesforce.fields.SalesforceAutoField(auto_created=True, db_column='Id', primary_key=True, serialize=False, verbose_name='ID')),
                ('name', salesforce.fields.CharField(db_column='Name', max_length=255, verbose_name='Product Name')),
                ('product_code', salesforce.fields.CharField(blank=True, db_column='ProductCode', max_length=255, null=True)),
                ('description', salesforce.fields.TextField(blank=True, db_column='Description', null=True, verbose_name='Product Description')),
                ...
                ('family', salesforce.fields.CharField(blank=True, choices=[('None', 'None')], db_column='Family', max_length=255, null=True, verbose_name='Product Family')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_text', salesforce.fields.CharField(max_length=40)),
                ('test_bool', salesforce.fields.BooleanField(default=False)),
                ('contact', salesforce.fields.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.contact')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', salesforce.fields.SalesforceAutoField(auto_created=True, db_column='Id', primary_key=True, serialize=False, verbose_name='ID')),
                ('what', salesforce.fields.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='task_what_set', to='fastsite.account')),
                ('who', salesforce.fields.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.lead')),
            ],
            options={
                'db_table': 'Task',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Pricebook2', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.pricebook')),
                ('Product2', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='organization_createdby_set', to='fastsite.user')),
                ('last_modified_by', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='organization_lastmodifiedby_set', to='fastsite.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.opportunity')),
                ('pricebook_entry', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.pricebookentry', verbose_name='Price Book Entry ID')),
                ('product2', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.product', verbose_name='Product ID')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='opportunity_roles', to='fastsite.contact')),
                ('opportunity', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_roles', to='fastsite.opportunity')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='contacts',
            field=models.ManyToManyField(related_name='opportunities', through='fastsite.OpportunityContactRole', to='fastsite.Contact'),
        ),
        migrations.AddField(
            model_name='lead',
            name='last_modified_by',
            field=salesforce.fields.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='lead_lastmodifiedby_set', to='fastsite.user'),
        ),
        migrations.AddField(
            model_name='lead',
            name='owner',
            field=salesforce.fields.ForeignKey(default=salesforce.fields.DefaultedOnCreate(fastsite.salesforce_models.User), on_delete=django.db.models.deletion.DO_NOTHING, related_name='lead_owner_set', to='fastsite.user'),
        ),
        migrations.AddField(
            model_name='contact',
            name='owner',
            field=salesforce.fields.ForeignKey(default=salesforce.fields.DefaultedOnCreate(fastsite.salesforce_models.User), on_delete=django.db.models.deletion.DO_NOTHING, related_name='contact_owner_set', to='fastsite.user'),
        ),
        migrations.CreateModel(
            name='Attachment',
            fields=[
                ...
                ('parent', salesforce.fields.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.test')),
            ],
            options={
                'db_table': 'Attachment',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', salesforce.fields.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='apex_email_notification', to='fastsite.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='account',
            name='Owner',
            field=salesforce.fields.ForeignKey(db_column='OwnerId', default=salesforce.fields.DefaultedOnCreate(fastsite.salesforce_models.User), on_delete=django.db.models.deletion.DO_NOTHING, to='fastsite.user'),
        ),
    ]
